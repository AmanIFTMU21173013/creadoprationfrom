  ...
  <div class='container'>
   <div class='card col-md-10 mx-auto'>
    <div class='card-body'>
     ...
     <form action="save-record.jsp" method="post"action="save-record.jsp" method="post"action="save-record.jsp" method="post">
       ...
       <div class='row form-group'>
        ...
        <div class='col-md-5'>
         ...
         <input type="text" name='city' id='city' class='form-control la' required>
        </div>
